	...
	@component('components/box')
		...
		@slot('action')
			@permission('group-create')
	            <a class="btn btn-success btn-xs" href="{{ route('groups.create') }}"><i class="fa fa-plus"></i> Add new group</a>
	            @endpermission
		@endslot
		...
		@slot('body')
			...
			<tr>
				...
				<td>{{ $group->type }}</td>
				<td>
					<a class="btn btn-info btn-xs" href="{{ route('groups.show',$group->id) }}" title="Show"><i class="fa fa-eye"></i></a>
					@permission('group-edit')
					<a class="btn btn-primary btn-xs" href="{{ route('groups.edit',$group->id) }}" title="Edit"><i class="fa fa-pencil"></i></a>
					@endpermission
